...
TUNABLES="SPEC_METHOD MAX_MODEL_LEN GPU_MEM_UTIL MAX_NUM_SEQS MAX_NUM_BATCHED_TOKENS KV_CACHE_DTYPE DFLASH_TOKENS NCCL_DEBUG NCCL_PROTO NCCL_ALGO NCCL_IB_TIMEOUT NCCL_IB_RETRY_CNT NCCL_BUFFSIZE EXTRA_ARGS MIXED_PREFILL_CHUNK EXL3_FAT_KERNEL SWAPPINESS"
